$('#buscarResumenClientes').on('click', function (event) {
    ...
    var idEmpresaSelect = $('#strEmpresaReporte').val();
...
//    var table = $('#comision_cliente').DataTable();
//    $('<table>')
...
//    });
    //    table.destroy();
   tableToExcel('comision_cliente2', 'Resumen de Comisiones por Cliente');
...
$('#cmd').on('click', function (event) {
    ...
    var pageContent = function (data) {
        ...
        doc.setFontType("bold");
        doc.text("Resumen de Comisiones por Cliente", 500, 22);
    ...
    doc.autoTable(res.columns, res.data, {
        ...
        //    if (cell.raw === 'CLIENTE') {//paint.Name header red
        ...
        //drawCell: function (cell, data) {
        //    // Rowspan
        //    if (data.column.dataKey === 'CLIENTE') {
    ...
    doc.save('Resumen de Comisiones por Cliente.pdf');

    //var dataSource = shield.DataSource.create({
    //    data: "#comision_cliente",
    //    schema: {
    //        type: "table",
    //        fields: {
    //            CLIENTE: { type: String },
    ...
    //        data,
    //        [
    //            { field: "CLIENTE", title: "CLIENTE", width: 400 },
    //            { field: "MONTO", title: "MONTO", width: 50 }
    //        ],
    //        {
    //            margins: {
    //                top: 50,
    ...
    //    pdf.saveAs({
    //        fileName: "PDF - Resumen de Comisiones por cliente"
    //    });
    //});
    //$('#comision_cliente').tableExport({ type: 'pdf', escape: 'false' });

    //$.ajax({
    //    type: 'POST',
    //    url: '/comisiones/Periodos/Export',
    //    data: 'GridHtml=' + $("#comision_cliente").html(),
   ...
   // $("input[name='GridHtml']").val($("#comision_cliente").html());
    ...
    //var res = pdf.autoTableHtmlToJson(document.getElementById("comision_cliente"));
    //pdf.autoTable(res.columns, res.data);
